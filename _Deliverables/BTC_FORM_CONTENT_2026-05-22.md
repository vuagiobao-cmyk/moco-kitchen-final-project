...
```text
Xây dựng 4 phần chính của hệ thống: (1) Website giới thiệu sản phẩm — hiển thị đẹp trên cả điện thoại lẫn máy tính; (2) Chatbot tư vấn sản phẩm — khách hỏi về bánh thì AI trả lời tự động, nhưng luôn nhắc khách hỏi bác sĩ nếu có bệnh nền; (3) Kho kiến thức trên NotebookLM — nơi AI tra cứu mọi thông tin chính xác về 7 loại bánh; (4) Công cụ viết bài tự động trên Google Sheets — founder chỉ cần gõ tên bánh, bấm 1 nút là có bài đăng Facebook.
```

**[CỘT: Deliverable chính]**
```text
Website giới thiệu sản phẩm (chạy trên mọi thiết bị), chatbot tư vấn AI tự động, kho kiến thức NotebookLM (7 nguồn, test 5 câu hỏi khó đều trả lời đúng), công cụ viết bài 1-click trên Google Sheets.
```
...
3. Đưa kho kiến thức lên NotebookLM: 7 nguồn tài liệu (menu, dinh dưỡng, FAQ, quy tắc giao tiếp...). Test 5 câu hỏi khó — 5/5 đều trả lời đúng.
4. Công cụ viết bài tự động trên Google Sheets: founder gõ tên bánh + chọn loại bài → bấm 1 nút → có bài viết + 3 ý tưởng ảnh.
5. Phác thảo kịch bản video demo 6 cảnh cho Veo 3.
```
...
Chi tiết Git theo từng tuần: xem file _Deliverables/GIT_WEEKLY_REPORT.md
```
...
3. Website giới thiệu sản phẩm — hiển thị 7 loại bánh, có chatbot tư vấn AI tự động. Khách hỏi "Tiểu đường ăn được không?" — chatbot giới thiệu sản phẩm phù hợp nhưng luôn nhắc hỏi bác sĩ.

4. Tích hợp 6 công cụ Google AI: NotebookLM, Gemini, Apps Script, Banana Pro (tạo ảnh), Veo 3 (kịch bản video), Vercel (đưa web lên internet).

Điểm đặc biệt: toàn bộ hệ thống tuân thủ nguyên tắc AI có trách nhiệm — không tuyên bố chữa bệnh, tự động cảnh báo thành phần rượu và dị ứng, luôn khuyên khách tham khảo bác sĩ.
```
