---
id: 20260513164600
aliases: ["NotebookLM Source List MOCO", "Danh mục tài liệu NotebookLM của MOCO"]
tags: ["#moco-kitchen", "#notebooklm", "#tai-lieu-nguon"]
created: 2026-05-13
updated: 2026-06-15
---

# NotebookLM Source List — MOCO Kitchen

NotebookLM được dùng để tổng hợp và tra cứu knowledge base của dự án. Mục đích là giúp founder nhanh chóng tìm lại thông tin về thị trường, sản phẩm, khách hàng và cách viết content.
...
| 2 | [`competitor_analysis_moco.md`](../1_Research/competitor_analysis_moco.md) | Competitor analysis và market gap |
...
| 5 | [`moco_menu_products.md`](../3_Content_Engine/moco_menu_products.md) | Product knowledge, nguyên liệu và bảo quản |
| 6 | [`moco_faq_nutrition.md`](../3_Content_Engine/moco_faq_nutrition.md) | FAQ về sản phẩm và dinh dưỡng |
| 7 | [`moco_content_calendar_sample.md`](../3_Content_Engine/moco_content_calendar_sample.md) | Content Calendar mẫu hai tuần |
...
| Viết bài giới thiệu Carrot Cake | Dùng đúng brand voice và nêu allergen |
