...
2. Scroll qua 7 sections: Hero → Products → Story → FAQ → Testimonials → Order → Footer
...
- API Key Gemini đang hardcode trong chatbot.js — chỉ dùng cho demo
- Sau khi demo xong, disable key tại [aistudio.google.com/apikey](https://aistudio.google.com/apikey)
